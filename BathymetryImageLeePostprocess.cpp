...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	CLeePostprocessMethod method(paramFile, sigma);
	int i, j, k;
	...
	out << "remote-sensing inversion\tLeeImagePostprocess" << endl;
	out << 8 << "\t" << 2 + method.NumEstimates() << endl;
