...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	const char* transectFile = inarg.Get("-ts", "C:\\Kubota\\Research\\HyperSpectralImages\\images\\CombinedInSituTransects41Bands.txt");
	...
	CLeeIterDiffuseMethod method(paramFile, speed, numiter);
	int i, j, k;
	...
	out << "remote-sensing inversion\tLeeImageIterDiffuse" << endl;
